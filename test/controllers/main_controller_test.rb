...
class MainControllerTest < ActionController::TestCase
  ...
  test 'should return the home page' do
    ...
    assert_select 'title', 'Adopt-a-Tree'
    assert_select 'p#tagline', 'Beautify your street by watering a tree.'
  end
