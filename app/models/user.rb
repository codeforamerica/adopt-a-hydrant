class User < ActiveRecord::Base
  ...
  has_many :reminders_to, :class_name => "Reminder", :foreign_key => "to_user_id", :dependent => :delete
  has_many :reminders_from, :class_name => "Reminder", :foreign_key => "from_user_id", :dependent => :delete
  has_many :things
